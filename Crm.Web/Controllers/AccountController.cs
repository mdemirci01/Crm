...
namespace Crm.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.Roles = new SelectList(ApplicationRoleManager.Roles.ToList(), "Id", "Name");
            return View();
        }
        private void CreateDefaultRoles()
        {
            ...
            {
                ApplicationRoleManager.Create(new IdentityRole() { Name = "Admin" });
            }
            if (!ApplicationRoleManager.RoleExists("User"))
            {
                ApplicationRoleManager.Create(new IdentityRole() { Name = "User" });
            }
        }
        //
